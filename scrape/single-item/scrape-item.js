...
(async () => {
    ...
    const itemURL = 'https://na.finalfantasyxiv.com/lodestone/playguide/db/item/94ccef34657/';
    ...
    async function scrapeItem() {
        ...
        db.query('SELECT COUNT(*) as count FROM materials;', (err, result) => {
            ...
            db.query(`INSERT INTO materials (material_id, name, icon, type) VALUES (6885, '${materialNameReplaced}', '${materialIcon}', '${materialTypeReplaced}')`, function (err, result) {
                if (err) throw err;
